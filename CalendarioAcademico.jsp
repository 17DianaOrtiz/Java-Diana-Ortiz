...
<body>
    ...
    <div class="header">
        ...
        <img src="img/logo.png" alt="logo" class="img-fluid mr-3" style="width: 180px; height: 140px;">
        ...
        <div class="col-md-6 mb-4">
            <div class="card text-center shadow border-success p-3">
                <div class="card-body">
                    ...
                    <p class="card-text">Ver el calendario académico para clases presenciales.</p>
                    <a href="archivos/CalendarioPresencial.pdf" target="_blank" class="btn btn-outline-success btn-block">
                        Ver Calendario
                    </a>
                </div>
            </div>
        ...
        <div class="col-md-6 mb-4">
            <div class="card text-center shadow border-success p-3">
                <div class="card-body">
                    ...
                    <p class="card-text">Ver el calendario académico para modalidad virtual.</p>
                    <a href="archivos/CalendarioVirtual.pdf" target="_blank" class="btn btn-outline-success btn-block">
                        Ver Calendario
                    </a>
                </div>
            </div>
