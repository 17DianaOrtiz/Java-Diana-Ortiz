...
<div class="register-container">
    ...
    <div class="form-section">
        ...
        <form action="GuarCalificacion3.jsp" method="post">

            <sql:query dataSource="${sistema}" var="listaProyectos">
                SELECT id FROM proyectos 
                WHERE  estado_final IS NULL AND calificacion_evaluador = 'Aprobado'
            </sql:query>
           ...
           <div class="form-check">
            ...
            <div class="form-group mt-2">
                <label for="enlace">Ingrese el enlace del radicado del comite:</label>
