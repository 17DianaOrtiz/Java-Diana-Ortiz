...
<div class="register-container">
    ...
    <div class="form-section">
        ...
        <form action="GuarCalificacion1.jsp" method="post">

            <sql:query dataSource="${sistema}" var="listaProyectos">
                SELECT p.id
                FROM proyectos p
                INNER JOIN profesores prof ON p.id_director = prof.id
                INNER JOIN usuarios u ON prof.usuario_id = u.id
                WHERE u.correo = ? AND p.calificacion_director IS NULL
           ...
           <div class="form-check">
            ...
            <div class="form-group mt-2">
                <label for="enlace">Ingrese el enlace del radicado:</label>
                <input type="text" class="form-control" name="enlace" placeholder="https://... o archivos/ejemplo.pdf">
            </div>
            
            
              
            <button type="submit" class="btn btn-success  btn-custom mt-1">Guardar</button>
            <a href="VerProyectoDirector.jsp" class="btn btn-light btn-custom mt-1">Regresar</a>
        </form>
    </div>
</div>
</div>
