                        ...
                        <div class="dropdown-menu" aria-labelledby="opcionesDropdown">
                            <c:choose>
                                ...
                                <c:when test="${rolNombre.rows[0].nombre eq 'Coordinación'}">
                                    ...
                                    <a class="dropdown-item" href="Proyectos.jsp">Ver Estado de Proyecto</a>
                                    <a class="dropdown-item" href="Ideas.jsp">Gestionar ideas de grado</a>
                                ...
                                <c:when test="${rolNombre.rows[0].nombre eq 'Estudiante'}">
                                    ...
                                    <a class="dropdown-item" href="VerProyecto.jsp">Ver el Estado del Proyecto</a>
                                    <a class="dropdown-item" href="CalendarioAcademico.jsp">Calendario Academico</a>
                                    <a class="dropdown-item" href="Formatos.jsp">Formatos de grado</a>
                                ...
                                <c:when test="${rolNombre.rows[0].nombre eq 'Director'}">
                                    ...
                                    <a class="dropdown-item" href="VerProyectoDirector.jsp">Evaluar Proyectos</a>
                                    <a class="dropdown-item" href="CalendarioAcademico.jsp">Calendario Academico</a>
                                    <a class="dropdown-item" href="Formatos.jsp">Formatos de grado</a>
...
<div class="register-container">
    ...
    <div class="form-section">
        ...
        <form action="CambiarAnteproyecto.jsp" method="post">

           <sql:query dataSource="${sistema}" var="listaProyectos">
               SELECT proyectos.id FROM proyectos INNER JOIN estudiantes on proyectos.id_estudiante1 = estudiantes.id  inner join usuarios on estudiantes.usuario_id= usuarios.id
            ...
            <div class="form-group">
                <label for="enlace">Ingrese el nuevo enlace de archivo anteproyecto:</label>
                <input type="text" class="form-control" name="enlace" placeholder="https://... o archivos/ejemplo.pdf" required>
            </div>
            
            
              
            <button type="submit" class="btn btn-success  btn-custom mt-1">Cambiar Anteproyecto</button>
