...
<div class="register-container">
    <div class="form-section ">
        ...
        <form action="ElIdea.jsp" method="post">
                    ...
                    <div class="col-md-6 mb-2">
                        <div class="card text-center shadow border-success p-1 ">
                            <div class="card-body ">
                                ...
                                <h5 class="card-title">Eliminar Idea</h5>
                                <p class="card-text">Ingrese el ID de la idea que desea eliminar.</p>
                                ...
                                <form action="ElIdea.jsp" method="post">
                                   <div class="form-group">
                                    ...
                                    <button type="submit" class="btn btn-success  btn-custom mt-1">Eliminar Idea</button>
