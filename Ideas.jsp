...
<div class="container mt-2 ">
    <h5 class="card-title text-center">Gestion de ideas de Proyectos de Grado</h5>
    <div class="row ">
        ...
        <div class="col-md-4 mb-4">
            <div class="card text-center shadow border-success p-3">
                <div class="card-body">
                    ...
                    <p class="card-text">Registrar Ideas</p>
                    <a href="GuardarIdea.jsp"  class="btn btn-outline-success btn-block">
                        Continuar
                    </a>
                </div>
            </div>
        ...
        <div class="col-md-4 mb-4">
            <div class="card text-center shadow border-success p-3">
                <div class="card-body">
                    ...
                    <p class="card-text">Eliminar Ideas</p>
                    <a href="EliminarIdea.jsp" class="btn btn-outline-success btn-block">
                       Continuar
                    </a>
                </div>
            </div>
        ...
        <div class="col-md-4 mb-4">
            <div class="card text-center shadow border-success p-3">
                <div class="card-body">
                    <i class="fas fa-pen-square fa-3x text-success mb-3"></i>
                    <p class="card-text">Actualizar Ideas</p>
                    <a href="ActualizarIdea.jsp"  class="btn btn-outline-success btn-block">
                        Continuar
                    </a>
                </div>
            </div>
