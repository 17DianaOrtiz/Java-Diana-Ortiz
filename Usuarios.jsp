        ...
        <div class="col-md-4 mb-4">
            <div class="card text-center shadow border-success p-3">
                <div class="card-body">
                    ...
                    <p class="card-text">Registrar Usuarios</p>
                    <a href="RegistrarUsuario.jsp"  class="btn btn-outline-success btn-block">
                        Continuar
                    </a>
                </div>
            </div>
        ...
        <div class="col-md-4 mb-4">
            <div class="card text-center shadow border-success p-3">
                <div class="card-body">
                    ...
                    <p class="card-text">Eliminar Usuarios</p>
                    <a href="EliminarUsuario.jsp" class="btn btn-outline-success btn-block">
                       Continuar
                    </a>
                </div>
            </div>
        ...
        <div class="col-md-4 mb-4">
            <div class="card text-center shadow border-success p-3">
                <div class="card-body">
                    ...
                    <a href="ActualizarUsuario.jsp"  class="btn btn-outline-success btn-block">
                        Continuar
                    </a>
                </div>
            </div>
