...
<nav class="navbar navbar-expand-lg navbar-dark navegacion">
    ...
    <div class="container d-flex justify-content-center align-items-center">
            ...
            <div class="d-flex flex-column m-4 justify-content-center">
                ...
                <a href="VerProyecto.jsp" class="btn btn-outline-secondary btn-custom">Volver</a>


                <h3 class="text-center "> Historial de anteproyecto</h3>
                <table class="table table-secondary table-striped table-bordered mt-3 ">
                    ...
                    <tbody>
                            <sql:query var="result" dataSource="${sistema}">
                                SELECT * FROM vista_anteproyectos where correo_estudiante1 = ?
                            ...
                            <c:forEach var="fila" items="${result.rows}">
                                <tr>
                                    ...
                                    <td><c:choose><c:when test="${empty fila.fecha_subida}">Sin gestionar</c:when><c:otherwise>${fila.fecha_subida}</c:otherwise></c:choose></td>
                                    <td><c:choose><c:when test="${empty fila.enlace}">Sin gestionar</c:when><c:otherwise>
                                        <a href="${fila.enlace}" target="_blank" class="btn btn-success">Abrir</a>
