    ...
    <div class="container d-flex justify-content-center align-items-center">
            ...
            <div class="d-flex flex-column m-4 justify-content-center">
                ...
                <table class="table table-secondary table-striped table-bordered mt-3 small">
                    <thead>
                        <tr>
                            <th style="width: 200px;">ID anteproyecto</th>
                    ...
                    <tbody>
                            <sql:query var="result" dataSource="${sistema}">
                                SELECT * FROM vista_proyectos_con_correo where correo_estudiante = ?
                ...
                <c:set var="hayProyecto" value="${not empty result.rows}" />

               <p>Seleccione gestionar para indicar la idea de proyecto y anteproyecto</p>
<a href="IndicarIdea.jsp" class="btn btn-outline-secondary btn-custom ${hayProyecto ? 'disabled' : ''}">Gestionar</a>
                
                    <p>Seleccione editar para corregir el anteproyectos</p>
            <a href="EditarAnteproyecto.jsp" class="btn btn-outline-secondary btn-custom">Editar</a>
                        
                <p>Historial de Anteproyectos</p>
                <a href="VerAnteproyectosEstudiante.jsp" class="btn btn-outline-secondary btn-custom">Historial</a>
            </div>
