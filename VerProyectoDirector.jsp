...
<nav class="navbar navbar-expand-lg navbar-dark navegacion">
    ...
    <div class="container d-flex justify-content-center align-items-center">
            ...
            <div class="d-flex flex-column m-4 justify-content-center">
                ...
                <table class="table table-secondary table-striped table-bordered mt-3 small">
                    <thead>
                        <tr>
                            ...
                            <th style="width: 150px;">Radicado</th>
                            
                        </tr>
                    </thead>
                    <tbody>
                            <sql:query var="result" dataSource="${sistema}">
                                SELECT * FROM vista_proyectos_director where correo_director = ?
                ...
                <a href="CalificarProyecto.jsp" class="btn btn-outline-secondary btn-custom">Gestionar</a>
                <p>Cambiar Calificacion</p>
                <a href="CambiarCalificacion.jsp" class="btn btn-outline-secondary btn-custom">Cambiar</a>
            </div>
